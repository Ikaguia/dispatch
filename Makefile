...
CFLAGS += -Wall -std=c++20 -D_DEFAULT_SOURCE -Wno-missing-braces -Wshadow -Wextra -Werror
...
INCLUDE_PATHS += -isystem $(RAYLIB_PATH)/src -isystem $(RAYLIB_PATH)/src/external
INCLUDE_PATHS += -isystem ./external/raylib-cpp -isystem ./external
